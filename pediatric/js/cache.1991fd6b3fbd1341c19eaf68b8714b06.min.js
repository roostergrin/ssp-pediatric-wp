...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){let carousel='.three-bubble-hero .three-bubble-carousel',log=!1,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function next_slide(){if($(carousel).find('.bubble-photo.active').next('.bubble-photo').length){$(carousel).find('.bubble-photo.active').removeClass('active').next('.bubble-photo').addClass('active')}else{$(carousel).find('.bubble-photo.active').removeClass('active');$(carousel).find('.bubble-photo:first').addClass('active')}}
function play(){paused=!1;if(!init)return!1;if($(carousel).find('.last-slide').length){$(carousel).find('.bubble-photo.last-slide').removeClass('last-slide').addClass('active')}else{$(carousel).find('.bubble-photo').first().addClass('active')}
init=!1}
function stop(){$(carousel).find('.bubble-photo.active').removeClass('active').addClass('last-slide');init=!0;autoplaying=!1}
function pause(){paused=!0}
if($(carousel).length){$(carousel).on('mouseenter',function(){pause()});$(carousel).on('mouseleave',function(){play()});$(window).on('load scroll resize',function(){if(window.innerWidth<=670){if(init)play();if(!autoplaying){autoplaying=!0;if(autoplay){autoplay_interval=setInterval(function(){if(!paused)next_slide()},autoplay_speed)}}}else{if(autoplaying){if(autoplay)clearInterval(autoplay_interval);autoplaying=!1}
if(!init)pause()}})}})(jQuery);(function($){function slideIn(){var boxContainer=$('.three-box-slide-in .box-container');boxContainer.each(function(){if($(this).is(':inview')){if($(this).find('.box.active').length==0){$(this).find('.box').addClass('active')}}else{$(this).find('.box').removeClass('active')}})}
$(window).on('scroll resize',slideIn)})(jQuery);$(document).ready(function(){function sixIconsCarousel(){var checkWidth=$(window).width();var sixIconsCarousel=$('.six-icons-carousel');sixIconsCarousel.each(function(){if(checkWidth>950){if(typeof $(this).data('owl.carousel')!='undefined'){$(this).data('owl.carousel').destroy()}
$(this).removeClass('owl-carousel')}else{$(this).addClass('owl-carousel');$(this).owlCarousel({slideSpeed:500,paginationSpeed:400,dots:!1,autoWidth:!1,loop:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!0,autoplayHoverPause:!0,nav:!1,responsiveClass:!0,responsive:{0:{items:1,},768:{items:2,}}})}})}
sixIconsCarousel();$(window).resize(sixIconsCarousel)});$(document).ready(function(){function fourIconsCarousel(){var checkWidth=$(window).width();var fourIconsCarousel=$('.four-icons-with-image-carousel');if(checkWidth>950){if(typeof fourIconsCarousel.data('owl.carousel')!='undefined'){fourIconsCarousel.data('owl.carousel').destroy()}
fourIconsCarousel.removeClass('owl-carousel')}else if(checkWidth<=950){fourIconsCarousel.addClass('owl-carousel');fourIconsCarousel.owlCarousel({slideSpeed:500,paginationSpeed:400,dots:!1,autoWidth:!1,loop:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!0,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{items:1,},768:{items:2,}}})}}
fourIconsCarousel();$(window).resize(fourIconsCarousel)});$(document).ready(function(){function doSlides(thing){if(thing.is(':inview')){if(thing.find('.slide.active').length==0){thing.find('.slide').addClass('active')}}else{thing.find('.slide').removeClass('active')}}
