...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));$(document).ready(function(){if($(window).width()<670){startCarousel()}
$(window).resize(function(){if($(window).width()<670){startCarousel()}else{stopCarousel()}});function startCarousel(){$(".slides").owlCarousel({slideSpeed:500,paginationSpeed:400,margin:0,autoplay:!0,items:1,loop:!0,})}
function stopCarousel(){var owl=$('.slides');owl.trigger('destroy.owl.carousel')}});(function($){let carousel='section.split-carousel',log=!0,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=5000,autoplay_interval=!1;function update_height(){}
