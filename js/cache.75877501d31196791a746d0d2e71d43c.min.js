...
let scroll_position=$(window).scrollTop();$(window).on('scroll',function(){let marker=map_markers.filter(function(a){return a.start_opened})[0];if(marker===undefined)return;let marker_offset=get_marker_offset(map_object,marker),marker_height=map_object.getZoom()>9?92:20,marker_top=$('#'+map_data.selector).offset().top+marker_offset.y,marker_btm=marker_top+marker_height,win_top=$(window).scrollTop(),win_btm=$(window).scrollTop()+$(window).height(),direction=$(window).scrollTop()>scroll_position?'down':'up';if((win_top<=marker_btm&&win_btm>=marker_top&&direction=='up')||(win_btm>=marker_top&&win_top<=marker_btm&&direction=='down')){marker.scrolled_in=!0;open_info_windows()}else if(!info_box.entered&&marker.scrolled_in&&marker.info.getVisible()){delete marker.scrolled_in;initial.searched=!1;close_info_box(marker.info)}});if(window.Stickyfill||null)Stickyfill.add($('#'+map_data.selector))})(jQuery);$(document).ready(function(){function doSlides(thing){if(thing.is(':inview')){if(thing.find('.slide.active').length==0){thing.find('.slide').addClass('active')}}else{thing.find('.slide').removeClass('active')}}
var variableSlideUpCarousel=$('#variable-slide-up-owl-carousel');function vsuCarousel(){var checkWidth=$(window).width();variableSlideUpCarousel.each(function(){if(checkWidth>950){if(typeof variableSlideUpCarousel.data('owl.carousel')!='undefined'){variableSlideUpCarousel.data('owl.carousel').destroy()}
variableSlideUpCarousel.removeClass('owl-carousel');doSlides(variableSlideUpCarousel)}else if(checkWidth<=950){if(!$(this).hasClass('kill-carousel')){$(this).find('.slide').removeClass('active');variableSlideUpCarousel.addClass('owl-carousel');variableSlideUpCarousel.owlCarousel({slideSpeed:500,paginationSpeed:400,dots:!1,autoWidth:!1,loop:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!0,autoplayHoverPause:!0,items:1,margin:10,})}else{doSlides($(this))}}})}
variableSlideUpCarousel.on('changed.owl.carousel',function(e){variableSlideUpCarousel.trigger('stop.owl.autoplay');variableSlideUpCarousel.trigger('play.owl.autoplay')});$('section.variable-slide-up-carousel .pagination .page-left').click(function(){variableSlideUpCarousel.trigger('prev.owl.carousel')});$('section.variable-slide-up-carousel .pagination .page-right').click(function(){variableSlideUpCarousel.trigger('next.owl.carousel')});vsuCarousel();$(window).on('scroll resize',vsuCarousel)});(function($){let carousel='section.split-carousel',log=!0,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=5000,autoplay_interval=!1;function update_height(){}
...
if($(carousel).length){$(carousel).find('.pagination-container .pagination .page-left').on('click',function(){prev_slide()});$(carousel).find('.pagination-container .pagination .page-right').on('click',function(){next_slide()});$(carousel).on('mouseenter',function(){pause()});$(carousel).on('mouseleave',function(){play()});$(window).on('scroll resize',function(){if($(carousel+':inview').length){if(init)play();if(!autoplaying){autoplaying=!0;if(autoplay){autoplay_interval=setInterval(function(){if(!paused)next_slide()},autoplay_speed)}}}else{if(autoplaying){if(autoplay)clearInterval(autoplay_interval);autoplaying=!1}
if(!init)pause()}
update_height()})}
function findShortcodeInBodyText(text){var openBracketIndex=text.indexOf('['),closeBracketIndex=text.indexOf(']'),shortcode='';if(openBracketIndex!==-1&&closeBracketIndex!==-1){shortcode=text.substring(openBracketIndex,closeBracketIndex+1)}
return shortcode}})(jQuery);(function($){let carousel='section.testimonials.carousel',log=!1,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function update_height(){}
function prev_slide(){if($(carousel).find('.content-carousel .carousel-item.active').prev('.carousel-item').length){$(carousel).find('.content-carousel .carousel-item.active').removeClass('active').prev('.carousel-item').addClass('active');$(carousel).find('.images-carousel .img-container.active').removeClass('active').prev('.img-container').addClass('active')}else{$(carousel).find('.content-carousel .carousel-item.active').removeClass('active');$(carousel).find('.images-carousel .img-container.active').removeClass('active');$(carousel).find('.content-carousel .carousel-item').last().addClass('active');$(carousel).find('.images-carousel .img-container').last().addClass('active')}
update_height()}
function next_slide(){if($(carousel).find('.content-carousel .carousel-item.active').next('.carousel-item').length){$(carousel).find('.content-carousel .carousel-item.active').removeClass('active').next('.carousel-item').addClass('active');$(carousel).find('.images-carousel .img-container.active').removeClass('active').next('.img-container').addClass('active')}else{$(carousel).find('.content-carousel .carousel-item.active').removeClass('active');$(carousel).find('.images-carousel .img-container.active').removeClass('active');$(carousel).find('.content-carousel .carousel-item:first').addClass('active');$(carousel).find('.images-carousel .img-container:first').addClass('active')}
update_height()}
...
function stop(){$(carousel).find('.content-carousel .carousel-item.active').removeClass('active').addClass('last-slide');$(carousel).find('.images-carousel .img-container.active').removeClass('active').addClass('last-slide');update_height();init=!0;autoplaying=!1}
function pause(){paused=!0}
if($(carousel).length){$(carousel).find('.pagination-container .pagination .icon-left-arrow-thick').on('click',function(){prev_slide()});$(carousel).find('.pagination-container .pagination .icon-right-arrow').on('click',function(){next_slide()});$(carousel).on('mouseenter',function(){pause()});$(carousel).on('mouseleave',function(){play()});$(carousel).on('click','a.read-more',function(e){e.preventDefault();$(this).parent().text($(this).parent().data('content'));update_height()});$(window).on('scroll resize',function(){if($(carousel+':inview').length){if(init)play();if(!autoplaying){autoplaying=!0;if(autoplay){autoplay_interval=setInterval(function(){if(!paused)next_slide()},autoplay_speed)}}}else{if(autoplaying){if(autoplay)clearInterval(autoplay_interval);autoplaying=!1}
if(!init)pause()}
update_height()})}})(jQuery);(function($){let carousel='section.slider',log=!0,time=0,init=!0,paused=!1,autoplay=!0,autoplaying=!1,autoplay_speed=7000,autoplay_interval=!1;function prev_slide(){if($(carousel).find('.images-carousel .img-container.active').prev('.img-container').length){$(carousel).find('.images-carousel .img-container.active').removeClass('active').prev('.img-container').addClass('active')}else{$(carousel).find('.images-carousel .img-container.active').removeClass('active');$(carousel).find('.images-carousel .img-container').last().addClass('active')}}
function next_slide(){if($(carousel).find('.images-carousel .img-container.active').next('.img-container').length){$(carousel).find('.images-carousel .img-container.active').removeClass('active').next('.img-container').addClass('active')}else{$(carousel).find('.images-carousel .img-container.active').removeClass('active');$(carousel).find('.images-carousel .img-container:first').addClass('active')}}
function play(){if(log)console.log('play()');paused=!1;if(!init)return!1;if($(carousel).find('.last-slide').length){$(carousel).find('.images-carousel .img-container.last-slide').removeClass('last-slide').addClass('active')}else{$(carousel).find('.images-carousel .img-container').first().addClass('active')}
init=!1}
function stop(){$(carousel).find('.images-carousel .img-container.active').removeClass('active').addClass('last-slide');init=!0;autoplaying=!1}
function pause(){paused=!0}
if($(carousel).length){$(carousel).find('.pagination-container .pagination .icon-left-arrow-thick').on('click',function(){prev_slide()});$(carousel).find('.pagination-container .pagination .icon-right-arrow').on('click',function(){next_slide()});$(carousel).on('mouseenter',function(){pause()});$(carousel).on('mouseleave',function(){play()});$(window).on('scroll resize',function(){if($(carousel+':inview').length){if(init)play();if(!autoplaying){autoplaying=!0;if(autoplay){autoplay_interval=setInterval(function(){if(!paused)next_slide()},autoplay_speed)}}}else{if(autoplaying){if(autoplay)clearInterval(autoplay_interval);autoplaying=!1}
if(!init)pause()}})}})(jQuery)