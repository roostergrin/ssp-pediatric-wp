...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));(function($){var providers_owl=$('.providers.carousel .providers-container.owl-carousel');providers_owl.owlCarousel({items:1,center:!1,loop:!0,nav:!1,dots:!1,autoplay:!0,autoplayTimeout:5000,autoplayHoverPause:!0,responsive:{0:{margin:30,stagePadding:40,},783:{margin:10,}}});providers_owl.on('changed.owl.carousel',function(e){providers_owl.trigger('stop.owl.autoplay');providers_owl.trigger('play.owl.autoplay')});$('.providers.carousel .pagination .page-left').click(function(){providers_owl.trigger('prev.owl.carousel')});$('.providers.carousel .pagination .page-right').click(function(){providers_owl.trigger('next.owl.carousel')})})(jQuery);(function($){var tri_carousel_owl=$('.tri-carousel.owl-carousel');tri_carousel_owl.owlCarousel({dots:!1,center:!0,autoWidth:!0,loop:!0,mouseDrag:!0,pullDrag:!0,freeDrag:!1,autoplay:!0,autoplayHoverPause:!0,responsiveClass:!0,responsive:{0:{margin:30,stagePadding:30,items:1},928:{margin:40,items:3}}});tri_carousel_owl.on('changed.owl.carousel',function(e){tri_carousel_owl.trigger('stop.owl.autoplay');tri_carousel_owl.trigger('play.owl.autoplay')});$('section.tri-carousel .pagination .page-left').click(function(){tri_carousel_owl.trigger('prev.owl.carousel')});$('section.tri-carousel .pagination .page-right').click(function(){tri_carousel_owl.trigger('next.owl.carousel')})})(jQuery)