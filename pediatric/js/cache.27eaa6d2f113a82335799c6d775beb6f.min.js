...
setInterval(function(){if($.jMaskGlobals.watchDataMask){$.applyDataMask()}},globals.watchInterval)}));$(document).ready(function(){function doSlides(thing){if(thing.is(':inview')){if(thing.find('.slide.active').length==0){thing.find('.slide').addClass('active')}}else{thing.find('.slide').removeClass('active')}}
