...
//			'apple' => '<span class="icon-adjust" style="display:flex;align-items:center;line-height:20px;"><img src="'.(get_stylesheet_directory_uri()).'/images/icons/apple.svg" height="20" />&nbsp;&nbsp;Apple</span>',
			...
			'insurance' => '<span class="icon-adjust" style="display:flex;align-items:center;line-height:20px;"><img src="'.(get_stylesheet_directory_uri()).'/images/icons/insurance.svg" height="20" />&nbsp;&nbsp;Location-pin</span>',
...
function add_hover_icon_selection_fields($key) {
	add_filter($key, function($field) {
		$field['choices'] = [
			...
			'insurance' => '<span class="icon-adjust" style="display:flex;align-items:center;line-height:20px;"><img src="'.(get_stylesheet_directory_uri()).'/images/icons-hover/h-insurance.svg" height="20" />&nbsp;&nbsp;Insurance</span>',
...
add_hover_icon_selection_fields('acf/load_field/key=financing_options_section_three_slide_3_icon');
